...
- **Activity** (таймлайн активности по сделке)
...
- **Нельзя удалить контакт, если есть сделки** в любой стадии.
- **Нельзя создать задачу для сделки другого пользователя**, если роль member.
- **Нельзя установить due_date в прошлом** (минимум «сегодня»).
- **Переход стадии сделки:**
...
- **Сводка по сделкам (/analytics/deals/summary)** для текущей организации:
